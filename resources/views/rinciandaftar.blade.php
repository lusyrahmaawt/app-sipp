...
@section('content')
    ...
    <body style="background-color: #8ca6ee;"> <!-- Atur latar belakang body -->
        <div class="container mt-5"> <!-- Atur margin top menggunakan Bootstrap -->
            <div class="row justify-content-center" style="padding: 8rem 0rem">
                <!-- Atur konten ke tengah menggunakan Bootstrap -->
                <div class="col-md-8 col-lg-6"> <!-- Menambahkan breakpoint untuk layar lebih besar -->
                    <div class="card shadow p-4 rounded-4"> <!-- Tambahkan shadow dan padding menggunakan Bootstrap -->
