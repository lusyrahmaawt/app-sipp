                  ...
                  <div class="card card-primary">
                    ...
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nik" id="exampleInputPassword1" placeholder="Nomor Induk Kependudukan">
                        @error('nik')
                        <small>{{ $message }}</small>
                        @enderror
                      </div>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_usaha" id="exampleInputPassword1" placeholder="Nama Usaha">
                        @error('nama_usaha')
                        <small>{{ $message }}</small>
                        @enderror
                      </div>
                      <div class="form-group">
                        ...
                        <input type="jenis_usaha" class="form-control" name="jenis_usaha" id="exampleInputPassword1" placeholder="Jenis Usaha">
                        @error('jenis_usaha')
                        <small>{{ $message }}</small>
                        @enderror
                      </div>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="alamat_usaha" id="exampleInputPassword1" placeholder="Alamat Usaha">
                        @error('alamat_usaha')
                        <small>{{ $message }}</small>
                        @enderror
                      </div>
