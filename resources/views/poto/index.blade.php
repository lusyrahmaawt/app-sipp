...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Halaman Foto Kegiatan</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('admin.poto.createpoto') }}" class="btn btn-primary mb-3">Upload Foto Kegiatan</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>
                                        <img src="{{ asset('storage/poto/'.$poto->poto) }}" height="100" alt=""> 
                                    </td>
                                    <td>
                                        {{ $poto->kegiatan }}
                                    </td>
