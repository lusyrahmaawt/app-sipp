    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 footer-items">
                ...
                <div class="border"></div>
                <ul>
                    <li><i class="fa fa-map-marker" aria-hidden="true"></i> Jl. HOS Cokroaminoto No.162, Tegalrejo, Kec.
                        Tegalrejo, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55244</li>
                ...
                <div class="social-media">
                    ...
                    <a href="https://wa.me/+6282121044424" target="_blank"><i class="fa fa-whatsapp"
