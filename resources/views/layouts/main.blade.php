...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset ('assets/sibakul-ukm.jpg')}}" alt="" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-3">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('assets/sibakul-ukm.jpg ')}}" alt=" " class="brand-image img-circle elevation-3" style="opacity: .8">
